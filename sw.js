...
var CACHE = "sunny-v-opt57";
/* opt57: network-first shell; bare URL always latest. Precache shell only. */
var PRECACHE = [
  "./",
  "index.html",
  "styles.css?v=opt57",
  "app.js?v=opt57",
  "vendor/maplibre-gl.js?v=opt57",
  "vendor/maplibre-gl.slim.css?v=opt57",
